...
/** SY rendering, for now SHOWFLAG_ALWAYS_ACCESSIBLE because it's exposed in SceneCapture */
SHOWFLAG_ALWAYS_ACCESSIBLE(SYRender, SFG_Normal, NSLOCTEXT("UnrealEd", "SYRenderSF", "SYRender"))
